...
public class UltimateShopSellTaskType extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public UltimateShopSellTaskType(BukkitQuestsPlugin plugin) {
        super( "zshop_sell", "DotDebian", "Purchase a given item from a ZShop shop", "zshop_sellcertain");
        this.plugin = plugin;
